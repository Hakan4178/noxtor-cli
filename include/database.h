 ...
 * @my_onion:      BİZİM bu peer'a özel .onion adresimiz (opsiyonel, NULL olabilir)
 * @my_onion_key:  BİZİM bu peer'a özel onion özel anahtarımız (opsiyonel, NULL olabilir)
 * @my_onion_key_len: Anahtar boyutu
 *
 ...
 * @my_onion_out:      BİZİM bu peer'a özel onion adresi (opsiyonel, NULL olabilir)
 * @my_onion_len:      my_onion_out boyutu
 * @my_onion_key_out:  BİZİM bu peer'a özel onion özel anahtarı (opsiyonel, NULL olabilir)
 * @my_onion_key_len_out: Çıktı anahtar boyutu
 *
