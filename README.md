...
<p align="center">
  ...
  <b>Early-Beta Tor-native · P2P · Minimal metadata · No server · No compromise</b><br>
...
CBMC and ESBMC VERIFICATION SUCCESSFUL (only log.c and arena.c and state_machine.c , partial stdin_handler.c)
