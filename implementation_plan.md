...
> [!IMPORTANT]
> **S1: Mesaj geçmişi güvenlik riski**
> Mesaj geçmişini diske (şifreli de olsa) kaydetmek, uygulama felsefesiyle uyuşuyor mu? Alternatif: sadece RAM'de son N mesaj tutulur, disk yazılmaz.

> [!IMPORTANT]
> **S2: ncurses zorunlu mu, opsiyonel mi?**
> ncurses yoksa (örneğin headless sunucu) mevcut ANSI TUI'ye fallback yapılsın mı, yoksa ncurses zorunlu bağımlılık mı olsun?

> [!IMPORTANT]
> **S3: Başlangıçta tüm peer'ların HS'lerini ayağa kaldırmak**
> Rehberde 15 kişi varsa, 15 ayrı `ADD_ONION` çağrısı yapılacak. Tor bunu destekler ama descriptor yayınlama süresi 30-60 saniye sürebilir. Startup bloklama stratejisi: tümünü arka planda mı yoksa sırayla mı?

> [!IMPORTANT]
> **S4: `NOX_MAX_PEERS` limiti**
> 16 yeterli mi, yoksa dinamik bir yapıya (linked list / realloc) mı geçilmeli?
...
- Aynı anda 2+ peer ile aktif sohbet
